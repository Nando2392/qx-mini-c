...
Current fixed-token result against llama.cpp commit `768d2a481a99cb75ec9a03b95dadbd35e7acf496`: exact end-to-end numerical parity remains **refuted**. The Q5_K, Q6_K attention, layer-47 attention/MoE and final-head same-input gates pass. With exact `layer-47.f32`, the final block reconstructs `l_out-47` at max-abs `2.57e-4`, RMSE `8.01e-6`, cosine ≈`1`, with identical top-8. The opt-in final head uses `Q6_K × Q8_K`, quantizes the normalized activation once and improves complete global logits to max-abs `0.132130`, RMSE `0.0257469`, cosine `0.999967105`, with argmax `1124`. F32 remains the default dequantized path. See [`wiki/comparisons/layer47-same-input.md`](wiki/comparisons/layer47-same-input.md) and [`wiki/comparisons/final-head-q6k-q8k.md`](wiki/comparisons/final-head-q6k-q8k.md).
...
1. Bisect layer 47 from its same input through attention/MoE to `l_out-47`; final RMSNorm and lm_head are closed independently.
