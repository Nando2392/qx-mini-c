...
int main(int argc, char **argv) {
    ...
    else if (strcmp(argv[1], "q6_k") == 0) block_size = sizeof(block_q6_K);
    ...
    else if (strcmp(argv[1], "q6_k") == 0) dequantize_row_q6_K((const block_q6_K *)raw, decoded, (int64_t)blocks * 256);
